...
import "./interfaces/IGravisRouter.sol";
...
contract GravisRouter is IGravisRouter02 {
    ...
    function removeLiquidity(
        ...
        address pair = GravisLibrary.pairFor(factory, tokenA, tokenB);
        IGravisERC20(pair).transferFrom(msg.sender, pair, liquidity); // send liquidity to pair
    ...
    function removeLiquidityWithPermit(
        ...
        IGravisERC20(pair).permit(msg.sender, address(this), value, deadline, v, r, s);
